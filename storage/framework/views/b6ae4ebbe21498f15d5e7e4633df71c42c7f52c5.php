                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(!empty($asr->keterangan)): ?>
                                                        <img src="<?php echo e(asset('img/bukti')); ?>/<?php echo e($asr->keterangan); ?>" width="70px" height="70px">
                                                    <?php else: ?>
                                                ...
                                                <td>
                                                <center><a href="<?php echo e(route('activity.show',$asr->id)); ?>" >
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TA\resources\views/asrama/index.blade.php ENDPATH**/ ?>