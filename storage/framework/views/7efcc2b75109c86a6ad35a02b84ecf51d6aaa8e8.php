...
<?php endif; ?>
<form method="POST" action="<?php echo e(route('pegawai.update',$edit->id)); ?>"
  ...
  &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
 <p type=" Nama Pegawai :">
      <input id="nama" name="nama" type="text" value="<?php echo e($edit->nama); ?>"></input></p>
...
<p type=" Alamat :">
<textarea id="alamat" name="alamat" cols="40" rows="5"><?php echo e($edit->alamat); ?> </textarea>

<p type=" No Hp :">
      <input id="hp" name="hp" value="<?php echo e($edit->hp); ?>" type="text"></input></p>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\bckp\TA2\resources\views/pegawai/form_edit.blade.php ENDPATH**/ ?>