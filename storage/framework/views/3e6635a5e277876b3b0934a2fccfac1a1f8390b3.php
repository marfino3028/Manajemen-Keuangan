        ...
        <div class="text-center">
            <?php if(!empty($akt->keterangan)): ?>
                <img id="myImg" style="width:100%;max-width:500px"
                     src="<?php echo e(asset('img/bukti')); ?>/<?php echo e($akt->keterangan); ?>" />
            <?php else: ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TA\resources\views/aktivitas/show.blade.php ENDPATH**/ ?>