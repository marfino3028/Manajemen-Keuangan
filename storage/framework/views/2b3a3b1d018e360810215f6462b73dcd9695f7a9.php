...
<nav class="navbar navbar-expand-lg px-4 py-2 bg-dark shadow"><a href="#" class="sidebar-toggler text-gray-500 mr-4 mr-lg-5 lead"><i class="fas fa-align-left"></i></a><a href="<?php echo e(url('/activity')); ?>" class="navbar-brand font-weight-bold text-uppercase text-base"><h5>Sisa Saldo : Rp. <?php echo e(number_format($sisasaldo,0,',','.')); ?>-,</h5></a>
    ...
    <ul class="ml-auto d-flex align-items-center list-unstyled mb-0">
      ...
      <div aria-labelledby="userInfo" class="dropdown-menu"><a  href= "<?php echo e(route('settings.show',$prof->id)); ?>"  class="dropdown-item"><strong class="d-block text-uppercase headings-font-family"><?php echo e(Auth::user()->name); ?></strong><small><?php echo e(Auth::user()->jabatan); ?></small></a>
           <div class="dropdown-divider"></div><a href="<?php echo e(route('settings.edit',$prof->id)); ?>" class="dropdown-item">Edit Profile</a>
...
<?php /**PATH C:\xampp\htdocs\bckp\TA2\resources\views/layouts/topbar.blade.php ENDPATH**/ ?>