                                    ...
                                    <thead>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(!empty($smk->keterangan)): ?>
                                                        <img src="<?php echo e(asset('img/bukti')); ?>/<?php echo e($smk->keterangan); ?>" width="70px" height="70px">
                                                    <?php else: ?>
                                                    ...
                                                    <?php endif; ?>
                                                    <td>
                                                    <center><a href="<?php echo e(route('activity.show',$smk->id)); ?>" >
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TA\resources\views/smk/index.blade.php ENDPATH**/ ?>