                  ...
                  <div class="card-body">
                    ...
                    <div class="sparkline20-list">
                        <div class="data-table-area-lg-12 mb-12">
                                ...
                                <table id="table" data-toggle="table" class="table card-text table-bordered"  data-search="true" data-show-columns="true"  data-key-events="true"  data-resizable="true" data-cookie="true"
                                    ...
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <a href="<?php echo e(route('pengeluaran.create')); ?>" class="btn btn-primary btn-md">
                                                    Tambah
                                                </a>&nbsp;&nbsp;
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <?php if(!empty($pemasukan->foto)): ?>
                                                        <img src="<?php echo e(asset('img')); ?>/<?php echo e($pengeluaran->foto); ?>" width="70px" height="70px">
                                                    <?php else: ?>
...
<?php echo $__env->make('layouts.index', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\TA2\resources\views/pengeluaran/index.blade.php ENDPATH**/ ?>