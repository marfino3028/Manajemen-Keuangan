...
<body class="bg-default" background="<?php echo e(asset('img/bg.png')); ?>">
      ...
      <div class="container px-12">
        ...
        <div class="collapse navbar-collapse" id="navbar-collapse-main">
          ...
          <div class="navbar-collapse-header d-md-none">
            <div class="row">
              <div class="col-6 collapse-brand">
                <a href="../index.html">
                  <img src="<?php echo e(asset('img/icon.png')); ?>">
                </a>
              </div>
          ...
          <ul class="navbar-nav ml-auto">
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="<?php echo e(url('https://ybmpln.org/')); ?>">
                <i class="ni ni-planet"></i>
                <span class="nav-link-inner--text">Dashboard</span>
              </a>
            </li>
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="<?php echo e(url('pemasukan-pdf')); ?>">
            ...
            <li class="nav-item">
              <a class="nav-link nav-link-icon" href="<?php echo e(url('pengeluaran-pdf')); ?>">
...
unset($__errorArgs, $__bag); ?>
  ...
  <script src="<?php echo e(asset('https://cdn.trackjs.com/agent/v3/latest/t.js')); ?>"></script>
  <script>
    window.TrackJS &&
      TrackJS.install({
...
<?php /**PATH C:\xampp\htdocs\TA\resources\views/auth/login.blade.php ENDPATH**/ ?>