...
<div class="invoice">
    ...
    <table border="1" cellspacing="0" cellpadding="0" width="100%">
        ...
        <td align="center">{{ $no++ }}</td>
          <td align="center" >{{ $smp->nama_jenis_anggaran }}</td>
          <td align="center" >{{ $smp->jenis_anggaran }}</td>
          <td align="center" >Rp.{{ number_format($smp->jumlah_anggaran,0,',','.') }}</td>
          <td align="center" >{{ $smp->peg }}</td>
          <td align="center" >{{ $smp->tgl_aktivitas }}</td>
        </tr>
        @endforeach
        </tbody>
        <tfoot>
