...
<div class="card shadow mb-10">
  ...
  <center>  <h5 class="m-0 font-weight-bold text-primary">{{ $peg->nama }}</h5></center>
    </div>
    <div class="card-body">
      ...
      @endforeach
      <center>  <a rel="nofollow" href="{{ url('/pegawai') }}" class="btn btn-primary btn-lg">Kembali</a></center>
    </div>
  </div>
