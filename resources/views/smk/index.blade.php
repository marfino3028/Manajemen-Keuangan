                                    ...
                                    <thead>
                                            ...
                                            <tr>
                                                ...
                                                <div class="bs-bars pull-left">
                                                    <a href="{{ url('smk-pdf') }}" class="btn btn-success btn-md">
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                <td>{{ $no++ }}</td>
                                                <td>{{ $smk->nama_jenis_anggaran }}</td>
                                                <td>{{ $smk->jenis_anggaran }}</td>
                                                <td>Rp. {{ number_format($smk->jumlah_anggaran,0,',','.') }}</td>
                                                <td>{{ $smk->peg }}</td>
                                                <td>{{ $smk->tgl_aktivitas }}</td>
                                                <td>
                                                    @if(!empty($smk->keterangan))
                                                        <img src="{{asset('img/bukti')}}/{{ $smk->keterangan }}" width="70px" height="70px">
                                                    @else
                                                    ...
                                                    @endif
                                                    <td>
                                                    <center><a href="{{ route('activity.show',$smk->id) }}" >
