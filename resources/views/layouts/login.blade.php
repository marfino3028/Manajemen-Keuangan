...
width: 1240px;
height: 362px;
background: linear-gradient(269.58deg, rgba(13, 14, 22, 0.45) 44.88%, rgba(52, 55, 84, 0.3825) 55.48%), #629dd9;
...
.knockout {
	...
	font-size:50pt;
	background: linear-gradient(110deg, #F7F7F7 33%, rgba(0, 0, 0, 0) 33%), linear-gradient(110deg, lightblue 34%, #f6d042 34%);
	background-size: 400%;
...
<!-- FOR  Background -->
    ...
    <img src="{{asset('img/ui2.png')}}" class="gbr1">
