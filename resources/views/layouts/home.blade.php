            ...
            <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
              <div class="flex-grow-1 d-flex align-items-left">
                ...
                <div class="text">
                  ...
                  <h6 class="mb-0">Total Rekap Pengeluaran</h6><span class="text-gray"><h6>{{ $totalrowout }}</h6></span>
          ...
          <div class="col-xl-3 col-lg-6 mb-2 mb-xl-0">
            <div class="bg-white shadow roundy p-4 h-100 d-flex align-items-center justify-content-between">
              <div class="flex-grow-1 d-flex align-items-right">
                ...
                <div class="text">
                  <h6 class="mb-0">Total Rekap Pemasukan </h6> <span class="text-gray"><h6> {{ $totalrowin }}</h6></span>
                </div>
              </div>
                ...
                <div class="card mb-1">
                    <div class="card-body">
                      <div class="row align-items-center flex-row">
                        <div class="col-lg-5">
                          <h2 class="mb-0 d-flex align-items-center"><span>{{ number_format($count,0) }} %</span><span class="dot bg-violet d-inline-block ml-3"></span></h2><span class="text-muted text-uppercase small">Pemasukan Yang Digunakan</span>
          ...
          <div class="col-lg-6 mb-0 mb-lg-0">
            <div class="card mb-3">
              <div class="card-body">
                <div class="row align-items-center flex-row">
                  <div class="col-lg-5">
                    <h2 class="mb-0 d-flex align-items-center"><span>{{ number_format($countin,0,',','.') }}%</span><span class="dot bg-green d-inline-block ml-3"></span></h2><span class="text-muted text-uppercase small">Sisa Saldo </span>
            ...
            <div class="card-body">
                ...
                <div class="chart-holder">
                    ...
                    Rp. {{ number_format($pemasukan,0,',','.') }}</span><span class="dot bg-green d-inline-block ml-3"></span></h2><span class="text-muted text-uppercase small"><br>Semua Jumlah Pemasukan</center></span>
                </div></div></div>
                </div>
              </div>
          </div>
  ...
  <div class="row text-dark">
    <div class="col-lg-4 mb-0 mb-lg-0">
      <div class="card rounded credit-card bg-hover-gradient-violet">
        <div class="content d-flex flex-column justify-content-between p-4">
          <h1 class="mb-5"><img src="{{asset('img\asrama.png')}}" width="200px" height="200px" class="gbr"></h1>
          <div class="d-flex justify-content-between align-items-end pt-3">
            ...
            <h3 class="mb-0">Rp.&nbsp;&nbsp;&nbsp;{{ number_format($pengeluaranasrama,0,',','.') }}-,</h3>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-4 mb-0 mb-lg-0">
      <div class="card rounded credit-card bg-hover-gradient-blue">
        <div class="content d-flex flex-column justify-content-between p-4">
          <h1 class="mb-5"><img src="{{asset('img/smp.png')}}" width="100px" height="100px" class="gbr"></h1>
          <div class="d-flex justify-content-between align-items-end pt-3">
            <div class="text-uppercase">
              <div class="font-weight-bold d-block">Pengeluaran</div><small class="text-gray">SMP</small>
            </div>
            <h3 class="mb-0">Rp.&nbsp;&nbsp;&nbsp;{{ number_format($pengeluaransmp,0,',','.') }}-,</h3>
          </div>
        </div>
      </div>
    </div>
    <div class="col-lg-4 mb-0 mb-lg-0">
      <div class="card rounded credit-card bg-hover-gradient-green">
        <div class="content d-flex flex-column justify-content-between p-4">
          <h1 class="mb-5"><img src="{{asset('img/smk.png')}}" width="75px" height="75px" class="gbr"></h1>
          <div class="d-flex justify-content-between align-items-end pt-3">
            <div class="text-uppercase">
              <div class="font-weight-bold d-block">Pengeluaran</div><small class="text-gray">SMK</small>
            </div>
            <h3 class="mb-0">Rp.&nbsp;&nbsp;&nbsp;{{ number_format($pengeluaransmk,0,',','.') }}-,</h3>
          </div>
        </div>
      </div>
    </div>
